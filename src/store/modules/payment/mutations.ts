...
export type Mutations<S = State> = {
  ...
  [LocalMutationTypes.CHANGE_PAYMENT_BEING_EDITED](state: S, payload: Payment): void;
}
...
export const mutations: MutationTree<State> & Mutations = {
  ...
  [LocalMutationTypes.CHANGE_PAYMENT_BEING_EDITED](state, payload: Payment) {
    state.paymentBeingEdited = payload;
  },
};
