...
export type Mutations<S = State> = {
  ...
  [LocalMutationTypes.CHANGE_FAQ_BEING_EDITED](state: S, payload: Faq): void;
}
...
export const mutations: MutationTree<State> & Mutations = {
  ...
  [LocalMutationTypes.CHANGE_FAQ_BEING_EDITED](state, payload: Faq) {
    state.faqBeingEdited = payload;
  },
};
